...
app.factory("Ratings", function(){
  ...
  var ntrp = {}
  ntrp["1.0"] = "This player is just starting to play tennis."
  ntrp["1.5"] = "This player has limited playing experience and is still working primarily on getting the ball into play."
  ntrp["2.0"] = "This player needs on-court experience. This player has obvious stroke weaknesses but is familiar with basic positions for singles and doubles play."
  ...
  ntrp["3.0"] = "This player is consistent when hitting medium pace shots, but is not comfortable with all strokes and lacks control when trying for directional intent, depth, or power."
  ...
  ntrp["4.0"] = "This player has dependable strokes, including directional intent, on both forehand and backhand sides on moderate shots, plus the ability to use lobs, overheads, approach shots and volleys with some success. This player occasionally forces errors when serving and teamwork in doubles is evident."
  ...
  ntrp["6.0"] = "These players will generally not need NRTP rankings. Rankings or past rankings will speak for themselves. The 6.0 player typically has had intensive training for national tournament competition at the junior level and collegiate levels and has obtained a sectional or national ranking."
  ...
  ntrp["7.0"] = "The 7.0 is a world class player who is committed to tournament competition on the international level and whose major source of income is tournament prize winnings."
